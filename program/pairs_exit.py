...
def manage_trade_exits(client):
    ...
    try:
        file_open_positions = open('bot_agents.json')
    ...
    for position in open_positions:
        ...
        size_m1 = position["order_m1_size"]
        side_m1 = position["order_m1_side"]

        m2 = position["market_2"]
        size_m2 = position["order_m2_size"]
        side_m1 = position["order_m2_side"]
        ...
        check_m1 = m1 == order_m1_market and size_m1 == order_m1_size and side_m1 == order_m1_side
        check_m2 = m2 == order_m2_market and size_m2 == order_m2_size and side_m1 == order_m2_side
        check_live = m1 in markets_live and m2 in markets_live

        if not check_m1 or not check_m2 or not check_live:
            print(f"WARNING: Not all open positions match records for {m1} and {m2}")
            continue
